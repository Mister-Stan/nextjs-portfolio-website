  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Planing and startegy"
          icon={<AceternityIcon order="Phase 1" />}
          description="We'll collaborate to map out your website's goal, taget audience, and key functionalities. We'll discuss things like site structure, navigation, and content requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketches to polished code, I keep you updated every stepo of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="This is where the magic happens! Based on approved design, I'll translate everything into functional code, building website from ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 h-[30rem] relative lg:h-[35rem] rounded-3xl overflow-hidden"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
